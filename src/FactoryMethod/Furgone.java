...
public class Furgone extends Veicolo {
    ...
    public Furgone(String codeVeicolo, String tipo, int capienza, String filialeAppartenenza, String destinazione, String stato, int capienzaDisponibile, DateTime dataUltimaModifica, double durata) {
